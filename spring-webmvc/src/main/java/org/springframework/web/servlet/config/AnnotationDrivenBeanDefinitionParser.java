...
class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext context) {
		...
		//第一个在这 RequestMappingHandlerMapping，实现了ApplicationAware接口，重写方法中将RequestMappingHandlerMapping
		//和拦截器关联在一起
		...
		//第二个在这 RequestMappingHandlerAdapter,实现InitializingBean接口，在afterPropertiesSet中关联参数解析器，绑定器，返回值解析器
