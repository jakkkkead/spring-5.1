 ...
 *
 * web容器和spring的中间层。在web项目种，通常会在web.xml种配置ContextLoaderListener,而在web容器启动
 * 过程，会实例化 ServletContextListener 的实例即：ContextLoaderListener。从而打通spring和web容器
 *
...
public class ContextLoaderListener extends ContextLoader implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		//tomcat启动时会触发该方法，实现servlet和spring关联的桥梁
